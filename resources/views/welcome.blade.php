...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Deri Hastalıkları Tahmin Uygulaması</title>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6" style="padding-bottom: 4em">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="/predict" class="underline text-gray-900 dark:text-white">{{ __('main.tahmin') }}</a></div>
                            </div>

                            <div class="ml-12 pb-3">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="text-align: justify">
                                    Yapay zeka ile anormal lezyonlara sahip deri görsellerini teşhis etmek için tıklayın.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="/home" class="underline text-gray-900 dark:text-white">{{ __('main.proff') }}</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm text-justify" style="text-align: justify">
                                    Sistemin veri tabanına uzman olarak veri eklemek için tıklayın.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="/docs" class="underline text-gray-900 dark:text-white">{{ __('main.documentation') }}</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="text-align: justify">
                                    Sistemin kullanımı hakkında dökümantasyona ulaşmak için tıklayın.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="/abstract" class="underline text-gray-900 dark:text-white">{{ __('main.about') }}</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" style="text-align: justify; padding-right:10px;">
                                    Bu proje <i> 2022-2023 Tübitak 2204-A Liseler Arası Proje Yarışması </i> için 
                                    derin öğrenme algoritmaları ve EfficientNet-B7 modeli kullanılarak
                                    açık kaynaklı veritabanlarında bulunan görseller ile eğitilmiş bir yapay zeka
                                    uygulamasıdır. Uygulama hakkında daha detaylı bilgi edinmek için tıklayın.
                                </div>
                            </div>
                        </div>
                    </div>

    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0" style="display: flex; justify-content: flex-start;">
            <div class="hidden fixed top-0 left-0 px-6 py-4 sm:block" style="margin-left: 15%;">
                ...
                <a href="{{ url('/abstract') }}" class="text-sm text-gray-700 dark:text-gray-500 underline"  style="border-bottom: 1px solid #ef3d2d; padding-bottom: 7px; text-decoration: none; color: #fff; font-size: 1.3em; margin-right: 1em;">{{ __('main.about') }}</a>
            </div>
            @if (Route::has('login'))
            ...
            <div class="container" style="color: #e2e8f0; font-size:21px;">
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        Deri hastalıkları insanların dış görünüşleri ile yakından ilgili olduğundan psikolojik
...
veri tabanlarında bulunan infeksiyöz deri hastalıkları, ekzama, akne, pigment hastalıkları, iyi ve kötü huylu tümör olmak üzere 6 farklı deri hastalığına ait 36.614 adet görsel kullanılmıştır. EfficientNet-B7 modeli ile transfer öğrenme metodolojisi kullanılarak geliştirilen derin öğrenme modelinin eğitim, test ve doğrulama aşamalarında kullanmak amacıyla veri seti 0.80:0.10:0.10 oranında bölünmüştür. Aşırı öğrenme probleminin önüne geçilmesi için veri artırma, erken durdurma ve öğrenme oranı azaltma teknikleri kullanılmıştır. Geliştirilen model 6 farklı deri hastalığı için %72,63 oranında doğru sınıflandırma yapmaktadır. Çalışmanın sonuçlarına göre pigmente bağlı deri hastalıkları için modele aktarılan veri miktarının yetersiz olmasından dolayı bu hastalığa ait tahmin başarımının diğerlerine göre düşük olduğu görülmüştür. Model, geliştirilen web tabanlı uygulama ile entegre edilerek hastalık teşhisi
yapan somut bir ürün haline getirilmiştir.
